 ...
 */
export type AgentStatus = 'queued' | 'in_progress' | 'requires_action' | 'cancelling' | 'cancelled' | 'failed' | 'completed' | 'expired';
/**
...
export type AgentEvent = IAgentEventRunCreated | IAgentEventRunStepCreated | IAgentEventMessageCreated | IAgentEventMessageDelta | IAgentEventMessageCompleted | IAgentEventToolCallCreated | IAgentEventToolCallCompletedByLLM | IAgentEventToolExecutionStarted | IAgentEventToolExecutionCompleted | IAgentEventRunRequiresAction | IAgentEventRunStatusChanged | IAgentEventRunFailed | IAgentEventRunCompleted | IAgentEventSubAgentInvocationStarted | IAgentEventSubAgentInvocationCompleted;
/**
