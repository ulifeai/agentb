    ...
    async executeSingleToolCall(toolCall, agentContext) {
        ...
        try {
            ...
            try {
                ...
                throw new errors_1.ValidationError(`Invalid JSON arguments for tool "${toolName}": ${e.message}`, { argumentsString: toolCall.function.arguments, error: e.message }, { toolName });
            }
            ...
            if (validationErrors.length > 0) {
                throw new errors_1.ValidationError(`Validation failed for tool "${toolName}": ${validationErrors.join(' ')}`, { errors: validationErrors }, { arguments: toolCall.function.arguments, parsedArgs: args, toolName });
            }
