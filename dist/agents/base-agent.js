...
const message_1 = require("../threads/message");
...
class BaseAgent {
    ...
    */
    async *run(agentContext, initialTurnMessages) {
        ...
        const toolExecutor = new tool_executor_1.ToolExecutor(toolProvider, runConfig.toolExecutorConfig, agentContext);
        ...
        try {
            ...
            while (true) {
                ...
                for (const msg of currentCycleInputMessages) {
                    const messageToStore = (0, message_1.mapLLMMessageToIMessagePartial)(msg, threadId, runId, currentStepId);
                ...
                const assistantMessageId = (0, uuid_1.v4)(); // Unique ID for the assistant's message this turn.
                ...
                const finalSavedAssistantMsg = await messageStorage.addMessage((0, message_1.mapLLMMessageToIMessagePartial)(finalAssistantLLMMessage, threadId, runId, currentStepId, assistantMessageId));
            ...
            const appError = error instanceof errors_1.ApplicationError
                ? error
                : new errors_1.ApplicationError(error.message || 'Unknown critical agent error.');
            yield this.createEventHelper('thread.run.failed', runId, threadId, {
                status: 'failed',
