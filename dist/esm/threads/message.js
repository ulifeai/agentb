 ...
 */
export function createMessageObject(threadId, role, content, metadata, id) {
    const now = new Date();
    return {
        id: id || uuidv4(),
        threadId,
 ...
 */
export function mapLLMMessageToIMessagePartial(llmMessage, threadId, runId, stepId, existingMessageId) {
 ...
 */
export function mapIMessageToLLMMessage(iMessage) {
    const llmMessage = {
        role: iMessage.role,
