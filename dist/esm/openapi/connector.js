...
import { GenericHttpApiTool, } from './tools/generic-http-tool';
/**
 ...
 */
export class OpenAPIOperationTool {
...
export class OpenAPIConnector {
    ...
    async executeGenericOperationInternal(args, agentContext) {
        ...
        console.debug(`[OpenAPIConnector] Executing Generic Request: ${opLabel}, URL: ${finalUrl}`, requestBody ? `with body (type ${typeof requestBody})` : 'No Body', `and headers: ${JSON.stringify(headersToObject(requestOptions.headers))}`);
