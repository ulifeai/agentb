 ...
 */
export function generateToolsSystemPrompt(toolSetName, toolSetDescription, toolDefinitions, apiInfo, // Generic API info
 ...
 */
export function generateGenericHttpToolSystemPrompt(operations, // From OpenAPISpecParser
 ...
 */
export async function generateRouterSystemPrompt(availableToolSets, apiInfo, // Generic API info
businessContextText) {
