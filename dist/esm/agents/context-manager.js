...
export const DEFAULT_CONTEXT_MANAGER_CONFIG = {
...
export class ContextManager {
    constructor(messageStorage, llmClient, config = {}) {
        ...
        if (this.config.tokenThreshold <= this.config.summaryTargetTokens + this.config.reservedTokens) {
            throw new ConfigurationError('ContextManager: tokenThreshold must be greater than summaryTargetTokens + reservedTokens.');
        }
    }
    /**
